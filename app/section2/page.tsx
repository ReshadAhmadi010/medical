  ...
  return (
    <div className='pb-24'>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex flex-col gap-5'>
          <h1 className="text-base leading-[150%] text-[#00000073]">
            By combining the expertise of our highly skilled surgical team with the <br />
            latest advancements in medical technology, we deliver precise and <br />
            minimally invasive procedures designed to reduce discomfort, minimize <br /> 
      ...
      <div className='flex gap-4 mt-10'>
        {cards.map((item) => (
          <div key={item.id} className='relative h-[330px] w-full rounded-lg overflow-hidden'>
            <Image
              src={item.image}
              alt={item.title}
              layout='fill'
            ...
            />
            <div className={`absolute bottom-0 left-0 right-0 p-4 flex items-center justify-between ${item.background ?? 'bg-black/60'}`}>
              <h3 className='text-white font-medium text-[24px]'>{item.title}</h3>
